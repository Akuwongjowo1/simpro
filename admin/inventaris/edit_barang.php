<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * from tb_barang,inventaris WHERE tb_barang.kd_barang=inventaris.kd_barang AND inventaris.kd_inventaris='".$_GET['kode']."'";
		...
		<div class="card-body">
			 ...
			 <div class="form-group row">
				...
				<div class="col-sm-6">
					...
					$data_cek['kd_inventaris']; ?>" readonly/>
				</div>
			</div>
    ...
    <div class="col-sm-6">
        <select name="nama" id="id_barang" class="form-control select2bs4" required>
            ...
            while ($row_barang = mysqli_fetch_array($hasil_barang)) {
                ...
                $selected = ($kd_barang == $data_cek['kd_barang']) ? 'selected' : '';
            ...
            <div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="alamat_tujuan" name="tujuan" placeholder="" value="<?php echo $data_cek['sisa']; ?>">
				</div>
			</div>
...
<?php
    ...
    $sql_ubah = "UPDATE inventaris SET 
		...
		WHERE kd_inventaris='".$_POST['kode']."'";
