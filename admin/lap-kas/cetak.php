...
$selectedProductName = $_GET['jenis'];

$rowNumber = 1;
if (isset($_GET['jenis'])) {
    $query = mysqli_query($mysqli, "SELECT * FROM anggaran  WHERE jenis='$selectedProductName'") or die('Ada kesalahan pada query tampil  : ' . mysqli_error($mysqli));
