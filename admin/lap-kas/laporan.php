...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Laporan Data KAS</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-kas/cetak.php" target="_blank">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<select name="jenis" id="jensis" class="form-control select2bs4" required>
