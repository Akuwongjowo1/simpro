...
$rowNumber = 1;
if (isset($_GET['nama'])) {
    $query = mysqli_query($mysqli, "SELECT * FROM barang_keluar,barang where barang.id_barang=barang_keluar.kd_barang AND nama_barang='$selectedProductName'") or die('Ada kesalahan pada query tampil  : ' . mysqli_error($mysqli));
