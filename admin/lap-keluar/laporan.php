...
function blah() {
   var a = window.open("admin/lap-keluar/cetaksemua.php");
}
</script>
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Laporan Barang Keluar</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-keluar/cetak.php" target="_blank">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				$query = "select * from barang_keluar,barang where barang.id_barang=barang_keluar.kd_barang";
