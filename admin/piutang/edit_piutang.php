<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * from piutang WHERE kode_piutang='".$_GET['kode']."'";
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="id_pindah" name="id_pindah" value="<?php echo $data_cek['kode_piutang']; ?>"
					 readonly/>
				</div>
			</div>
...
<div class="form-group row">
		...
		<div class="card-footer">
			...
			<a href="?page=data-piutang" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    if (isset ($_POST['Ubah'])){
    $sql_ubah = "UPDATE piutang SET 
		kproyek='".$_POST['kode']."',
		nominal=	 '".$_POST['nama']."',
		tgl=	 '".$_POST['tgl']."',
			keterangan='".$_POST['ket2']."'
		WHERE kode_piutang='".$_POST['id_pindah']."'";
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=data-piutang';
        }
      })</script>";
      }else{
      echo "<script>
