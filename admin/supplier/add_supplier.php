...
<div class="form-group row">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="alamat_tujuan" name="bank" placeholder="">
				</div>
			</div>
            <div class="form-group row">
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_supplier (kode, 	kategori, nama, alamat,telpon,	email,pic,bank,ket) VALUES (
			'".$_POST['kode']."',
            '".$_POST['kategori']."',
			'".$_POST['nama']."',
			'".$_POST['alamat']."',
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-supplier';
          }
      })</script>";
    }}
