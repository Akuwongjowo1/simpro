...
$rowNumber = 1;
if (isset($_GET['nama'])) {
    $query = mysqli_query($mysqli, "SELECT * FROM tb_kontraktor where nama_kontraktor='$selectedProductName'") or die('Ada kesalahan pada query tampil  : ' . mysqli_error($mysqli));
    $count = mysqli_num_rows($query);
}
?>
<html>
<head>
    <title>LAPORAN KONTRAKTOR</title>
    <style>
        body {
