...
<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" pattern="[0-9]+" class="form-control" id="alamat_tujuan" name="nama" placeholder="" required>
				</div>
			</div>
            <div class="form-group row">
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO pproyek (kode_pp,kproyek,nominal,tgl,keterangan) VALUES (
			'".$_POST['']."',
           '".$_POST['kode']."',
			 '".$_POST['nama']."',
			'".$_POST['tgl']."',
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-pproyek';
          }
      })</script>";
    }}
