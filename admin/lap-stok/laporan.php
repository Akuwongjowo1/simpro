...
function blah() {
   var a = window.open("admin/lap-stok/cetaksemua.php");
}
</script>
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Laporan Data Stok</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-stok/cetak.php" target="_blank">
		<div class="card-body">
