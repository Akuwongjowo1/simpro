...
<br>
    ...
    if ($result_last_invoice->num_rows > 0) {
        ...
        $last_invoice_number = intval($row_last_invoice['last_invoice']) + 1;
    }

    // Numeric invoice number
    $numeric_invoice_number = $last_invoice_number;
?>



          <input type="text" name="no[]" class="form-control" value="<?php echo $last_invoice_number; ?>" readonly>
