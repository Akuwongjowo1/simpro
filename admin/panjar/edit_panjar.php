<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * from panjar WHERE kode_p='".$_GET['kode']."'";
		...
		<div class="card-body">
			...
			<div class="form-group row">
			 ...
			 <div class="form-group row">
				...
				<div class="col-sm-6">
					<input name="ket1" type="text" required class="form-control" id="alamat_tujuan" placeholder="" value="<?php echo $data_cek['panjar']; ?>">
				</div>
			</div>
		  ...
		  <div class="form-group row">
				...
				<div class="col-sm-6">
					<input name="sumber" type="text" required class="form-control" id="alamat_tujuan" placeholder="" value="<?php echo $data_cek['sumber']; ?>">
			 </div>
			</div>
