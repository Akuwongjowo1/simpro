...
function blah() {
   var a = window.open("admin/lap-proyek/cetaksemua.php");
}
</script>
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Laporan Data Proyek</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-proyek/cetak.php" target="_blank">
		<div class="card-body">
			...
			<div class="form-group row">
			    ...
			    <label class="col-sm-2 col-form-label">Pilih Nama Proyek</label>
				<div class="col-sm-6">
