...
function blah() {
   var a = window.open("admin/lap-supplier/cetaksemua.php");
}
</script>
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Laporan Data Supplier</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-supplier/cetak.php" target="_blank">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				?>
						<option value="<?php echo $row['ksupplier'] ?>">
							<?php echo $row['ksupplier'] ?>
