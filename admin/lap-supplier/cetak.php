...
$no = 1;
if (isset($_GET['no_kk'])) {
    $query = mysqli_query($mysqli, "SELECT * FROM hs where ksupplier='$jekel1'") 
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">KODE SUPPLIER</th>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                       <td width='40' height='13' align='center' valign='middle'>$no</td>
                        <td width='120' height='13' align='center' valign='middle'>$data[ksupplier]</td>
...
<?php
$filename="LAPORAN HUTANG SUPPLIER.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
