...
$rowNumber = 1;
    $query = mysqli_query($mysqli, "SELECT * FROM nota,barang,tb_pengguna,proyek where barang.id_barang=nota.id_barang and tb_pengguna.id_pengguna=nota.id_member and proyek.kode=nota.proyek") or die('Ada kesalahan pada query tampil  : ' . mysqli_error($mysqli));
