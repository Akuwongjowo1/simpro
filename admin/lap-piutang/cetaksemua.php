...
$no = 1;
$query = mysqli_query($mysqli, "SELECT * FROM piutang,proyek where piutang.kproyek=proyek.kode ") 
...
<?php
$filename="LAPORAN PIUTANG.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
