...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Detail Pemesanan</h3>
	</div>
...
<div class="form-group row">
 ...
 <div class="form-group row">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-4">
					<select name="statuss" id="level" class="form-control" >
		...
		<div class="card-footer">
			...
			<a href="?page=data-lapangan" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
