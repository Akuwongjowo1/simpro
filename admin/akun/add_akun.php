...
<div class="form-group row">
		...
		<div class="card-footer">
			...
			<a href="?page=data-akun" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO akun (kode,nama) VALUES (
			'".$_POST['kode']."',
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-akun';
          }
      })</script>";
      }else{
      echo "<script>
