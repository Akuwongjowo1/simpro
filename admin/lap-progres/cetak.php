...
$rowNumber = 1;
if (isset($_GET['nama'])) {
    $query = mysqli_query($mysqli, "SELECT * FROM pekerjaan,proyek WHERE pekerjaan.kproyek=proyek.kode and proyek.nama='$selectedProductName'") or die('Ada kesalahan pada query tampil  : ' . mysqli_error($mysqli));
