...
$rowNumber = 1;
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM barang_masuk,barang where barang.id_barang=barang_masuk.kd_barang ") or die('Ada kesalahan pada query tampil  : ' . mysqli_error($mysqli));
