...
function blah() {
   var a = window.open("admin/lap-masuk/cetaksemua.php");
}
</script>
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Laporan Barang Masuk</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-masuk/cetak.php" target="_blank">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				$query = "select * from barang_masuk,barang where barang.id_barang=barang_masuk.kd_barang";
