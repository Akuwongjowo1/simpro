	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" pattern="[A-Za-z ]+" class="form-control" id="nama_pengguna" name="nama_pengguna" placeholder="Nama user" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<select name="level" id="level" class="form-control">
						...
						<option selected="selected">Pengawas</option>
					</select>
				</div>
			</div>
