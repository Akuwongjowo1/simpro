...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Terima Pesanan</h3>
	</div>
...
<div class="form-group row">
 ...
 <div class="form-group row">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="alamat_tujuan" name="tgl" placeholder="" value="<?php echo $data_cek['lapangan']; ?>"readonly/>
					</div>
					</div>
				<div class="form-group row">
		...
		<div class="card-footer">
			<input type="submit" name="Ubah" value="Terima Pesanan" class="btn btn-success">
...
<?php
    ...
    $sql_ubah = "UPDATE pemesanan SET 
		...
		WHERE kd_pemesanan='" . $_POST['kode']. "' AND kd_barang='" . $_POST['kode_barang']. "'";
