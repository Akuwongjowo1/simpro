<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * from tb_karyawan WHERE kode='".$_GET['kode']."'";
...
<div class="form-group row">
				...
				<div class="col-sm-6">
					<input name="nama" type="text" class="form-control" id="alamat_tujuan" placeholder="" pattern="[A-Za-z ]+" value="<?php echo $data_cek['nama_karyawan']; ?>">
				</div>
			</div>
            <div class="form-group row">
          ...
          <div class="form-group row">
				...
				<div class="col-sm-6">
					<input name="ket" type="text" class="form-control" id="alamat_tujuan" placeholder="" value="<?php echo $data_cek['jabatan']; ?>">
			  </div>
			</div>
