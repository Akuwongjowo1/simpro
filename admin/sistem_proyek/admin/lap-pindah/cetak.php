...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tb_pindah
                                    WHERE tgl_pindah BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ") 
                ...
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                      <th height="20" align="center" valign="middle">NO.</th>
                        <th height="20" align="center" valign="middle">ID PINDAH</th>
                        <th height="20" align="center" valign="middle">ID PENDUDUK</th>
                        <th height="20" align="center" valign="middle">TANGGAL PINDAH </th>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                       <td width='40' height='13' align='center' valign='middle'>$no</td>
                        <td width='120' height='13' align='center' valign='middle'>$data[id_pindah]</td>
                        <td width='120' height='13' align='center' valign='middle'>$data[id_pdd]</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[tgl_pindah]</td>
...
<?php
$filename="LAPORAN DATA PINDAH.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
