...
if (isset($_GET['tgl_awal'])) {
    $no    = 1;
    $query = mysqli_query($mysqli, "SELECT * FROM hb WHERE tgl BETWEEN '$tgl_awal' AND '$tgl_akhir'") 
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                       <td width='40' height='13' align='center' valign='middle'>$no</td>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[tgl]</td>
                        
                        <td width='150' height='13' align='center' valign='middle'>$data[ket]</td>
...
<?php
$filename="LAPORAN DATA HUTANG BANK.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
