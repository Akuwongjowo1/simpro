        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                       <td width='40' height='13' align='center' valign='middle'>$no</td>
                        ...
                        <td style='padding-left:5px;' width='100' height='13' valign='middle'>$data[ket]</td>
...
<?php
$filename="LAPORAN PEGELUARAN OPERASIONAL.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
