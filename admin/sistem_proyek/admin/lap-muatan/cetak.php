...
$no = 1;
if (isset($_GET['no_kk'])) {
    $query = mysqli_query($mysqli,"SELECT a.kd_barang,a.nama,a.supplier,b.kode,b.supir,b.no_hp,b.kd_barang,b.awal,b.bongkar,b.selisih,b.total,b.panjar,b.sisa,b.tujuan,b.ket
                 FROM tb_barang as a INNER JOIN tb_muatan as b ON a.kd_barang=b.kd_barang where b.supir='$jekel1'")
