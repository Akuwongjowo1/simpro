...
$jekel1    = $_GET['id_jekel'];


if (isset($_GET['id_jekel'])) {
    $query = mysqli_query($mysqli, "SELECT *
                                    FROM tb_pdd 
                                    WHERE jekel BETWEEN '$jekel1' AND '$jekel1'
                                    ORDER BY id_pend ASC") 
...
<?php
$filename="LAPORAN DATA OBAT PENDUDUK.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
