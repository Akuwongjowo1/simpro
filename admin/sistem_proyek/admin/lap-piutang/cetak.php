...
$no = 1;
if (isset($_GET['no_kk'])) {
    $query = mysqli_query($mysqli, "SELECT * FROM piutang,proyek where piutang.kproyek=proyek.kode and piutang.kproyek='$jekel1'") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN PIUTANG PROYEK</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN PIUTANG PROYEK
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">NAMA PROYEK</th>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                       <td width='40' height='13' align='center' valign='middle'>$no</td>
                        ...
                        <td style='padding-left:5px;' width='100' height='13' valign='middle'>$data[keterangan]</td>
...
<?php
$filename="LAPORAN PIUTANG PROYEK.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
