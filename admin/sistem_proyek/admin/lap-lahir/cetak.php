...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tb_lahir 
                                    WHERE tgl_lh BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ") 
                ...
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                       <th height="20" align="center" valign="middle">NO.</th>
                        <!--<th height="20" align="center" valign="middle">ID LAHIR</th>-->
                        ...
                        <th height="20" align="center" valign="middle">ID KK</th>
                    </tr>
                </thead>
                <tbody>
<?php
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                       <td width='40' height='13' align='center' valign='middle'>$no</td>
                        <td style='padding-left:5px;' width='50' height='13' valign='middle'>$data[nama]</td>
                        <td width='120' height='13' align='center' valign='middle'>$data[nik]</td>
                        <td width='100' height='13' align='center' valign='middle'>$data[tgl_lh]</td>
                        <td width='100' height='13' align='center' valign='middle'>$data[jekel]</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[id_kk]</td>
                    </tr>";
            $no++;
        }
    }
...
<?php
$filename="LAPORAN DATA KELAHIRAN.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
