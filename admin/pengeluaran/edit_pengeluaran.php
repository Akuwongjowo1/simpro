<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * from pengeluaran WHERE kode='".$_GET['kode']."'";
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
          ...
          <div class="form-group row">
				...
				<div class="col-sm-6">
					<input name="ket2" type="text" required class="form-control" id="alamat_tujuan" placeholder="" value="<?php echo $data_cek['ket']; ?>">
			  </div>
			</div>
		...
		<div class="card-footer">
			...
			<a href="?page=data-pengeluaran" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    if (isset ($_POST['Ubah'])){
    $sql_ubah = "UPDATE pengeluaran SET 
		nominal='".$_POST['nama']."',
			tgl='".$_POST['tgl']."',
			ket='".$_POST['ket2']."'
