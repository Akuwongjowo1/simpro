...
class view
{
    ...
    {
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, tb_pengguna.id_pengguna,
                tb_pengguna.nama_pengguna from nota 
                left join barang on barang.id_barang=nota.id_barang 
                left join tb_pengguna on tb_pengguna.id_pengguna=nota.id_member 
                where nota.periode = ?
    ...
    public function periode_jual($periode)
    {
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, tb_pengguna.id_pengguna,
                tb_pengguna.nama_pengguna from nota 
                left join barang on barang.id_barang=nota.id_barang 
                left join tb_pengguna on tb_pengguna.id_pengguna=nota.id_member WHERE nota.periode = ? 
    ...
    public function hari_jual($hari)
    {
        ...
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang,  barang.harga_beli,  tb_pengguna.id_pengguna,
                tb_pengguna.nama_pengguna from nota 
                left join barang on barang.id_barang=nota.id_barang 
                left join tb_pengguna on tb_pengguna.id_pengguna=nota.id_member WHERE nota.tanggal_input LIKE ? 
                ORDER BY id_nota ASC";
        $row = $this-> db -> prepare($sql);
    ...
    {
        $sql ="SELECT penjualan.* , barang.id_barang, barang.nama_barang,  tb_pengguna.id_pengguna,
                tb_pengguna.nama_pengguna from penjualan 
                left join barang on barang.id_barang=penjualan.id_barang 
                left join tb_pengguna on tb_pengguna.id_pengguna=penjualan.id_member
