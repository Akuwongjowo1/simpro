...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-file"></i> Cetak Purchase Order</h3>
	</div>
	<form role="form" class="form-horizontal" method="GET" action="admin/lap-po/cetaksemua.php" target="_blank">
		<div class="card-body">
				...
				$query = "select distinct kproyek from pekerjaan";
